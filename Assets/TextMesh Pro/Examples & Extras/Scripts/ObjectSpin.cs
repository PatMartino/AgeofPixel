...
#pragma warning disable 0414
        ...
        private Vector3 _mİnitialRotation;
        private Vector3 _mİnitialPosition;
        ...
        void Awake()
        {
            ...
            _mİnitialRotation = _mTransform.rotation.eulerAngles;
            _mİnitialPosition = _mTransform.position;
        ...
        void Update()
        {
            ...
            else if (motion == MotionType.BackAndForth)
            {
                ...
                _mTransform.rotation = Quaternion.Euler(_mİnitialRotation.x, Mathf.Sin(_mTime) * rotationRange + _mİnitialRotation.y, _mİnitialRotation.z);
            }
            else
            {
                _mTime += spinSpeed * Time.deltaTime;
                ...
                _mTransform.position = _mİnitialPosition + new Vector3(x, z, y);
