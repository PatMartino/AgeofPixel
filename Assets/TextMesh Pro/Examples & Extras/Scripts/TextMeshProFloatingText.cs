...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("IsTextObjectScaleStatic")] public bool ısTextObjectScaleStatic;

        //private int m_frame = 0;

        static WaitForEndOfFrame _kWaitForEndOfFrame = new WaitForEndOfFrame();
        static WaitForSeconds[] _kWaitForSecondsRandom = new WaitForSeconds[]
        {
        ...
        void Start()
        {
            if (spawnType == 0)
            {
                ...
                _mTextMeshPro.isTextObjectScaleStatic = ısTextObjectScaleStatic;
